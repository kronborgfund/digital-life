...
export function SituationPage() {
  ...
  const [language, setLanguage] = useState<Language>(lang as Language || 'da')
  ...
  const handleNext = () => {
    if (currentSituation && currentStep < currentSituation.steps.length - 1) {
      ...
      <Card>
        ...
        <CardContent>
          {currentSituation ? (
            ...
            <p>No situation found for: {situation}</p>
          )}
        </CardContent>
      </Card>
    </div>
